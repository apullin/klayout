...
run_klayout() {
  ...
  local -a command=(
    ...
    -u KLAYOUT_CUDA_CONTACT4_ACTIVE_UNION_MAX_CELLS
    -u KLAYOUT_CUDA_CONTACT4_ACTIVE_UNION_MAX_CONTEXTS
    -u KLAYOUT_CUDA_CONTACT4_ACTIVE_UNION_MAX_STORED_POLYGONS
    -u KLAYOUT_CUDA_CONTACT4_ACTIVE_UNION_MAX_STORED_EDGES
    -u KLAYOUT_CUDA_CONTACT4_ACTIVE_UNION_MAX_FLAT_POLYGONS
    -u KLAYOUT_CUDA_CONTACT4_ACTIVE_UNION_MAX_FLAT_EDGES
